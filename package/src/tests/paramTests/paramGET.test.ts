...
import SampleController from "./controllers/sampleGet.controller";
...
describe("GET tests : Check if request params,body and query is recieved using @reqParams, @reqBody and @reqParams decorators for GET routes", () => {
