...
import SampleController from "./controllers/sampleDel.controller";
...
describe("DEL tests : Check if request params,body and query is recieved using @reqParams, @reqBody and @reqParams decorators for DEL routes", () => {
