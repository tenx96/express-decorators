...
import SampleController from "./controllers/samplePost.controller";
...
describe("POST tests : Check if request params,body and query is recieved using @reqParams, @reqBody and @reqParams decorators for POST routes", () => {
